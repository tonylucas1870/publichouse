-- Update demo property function with proper JSON construction
  ...
  IF v_property_id IS NULL THEN
    ...
    WITH sofa AS (
      SELECT jsonb_array_elements(contents)->>'id' as id,
             jsonb_array_elements(contents)->>'name' as name,
             jsonb_array_elements(contents)->>'description' as description
